    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col gap-2'>
            ...
            <div>
                ...
                <input required value={form.title} onChange={handleChangeForm} type="text" name='title' id="title" className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:bg-blue-100 bg-white text-black" placeholder="#Es viernes!" />
            </div>
            <div>
                ...
                <textarea value={form.content} required id="message" onChange={handleChangeForm} name='content' rows={3} className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:bg-blue-100 bg-white text-black" placeholder="¿Que estas pensando?"></textarea>
            </div>
