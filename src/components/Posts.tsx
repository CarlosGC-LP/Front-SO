...
export const Posts = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-16'>
      <ToastContainer />
      {!user?.token ? (<div className='mb-4'>
        <h1 className='text-xl mb-4'>Inicia sesión para comentar los posts</h1>
        <Link to='/login' className=" text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ingresar</Link>
      </div>) : (
        <div>
            <h1 className='text-xl mb-4'>Bienvenido a SocialWave {user.email}</h1>
          <CreatePost />
        </div>
      )}
      <div>
